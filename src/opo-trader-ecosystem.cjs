module.exports = {
  apps: [{
    name: 'opo-trader',
    script: '/Users/opoclaw1/claudeclaw/src/opo-trader.cjs',
    ...
    error_file: '/Users/opoclaw1/claudeclaw/logs/opo-trader-pm2-error.log',
    out_file: '/Users/opoclaw1/claudeclaw/logs/opo-trader-pm2-out.log',
